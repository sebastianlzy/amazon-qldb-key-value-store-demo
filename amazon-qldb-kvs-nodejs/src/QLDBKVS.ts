...
const qldbClient: QLDB = new QLDB({region: process.env.AWS_DEFAULT_REGION});
const fs = require('fs');
...
export class QLDBKVS {
     ...
     * @param region set AWS region (default=ap-southeast-1)
     ...
     */
    constructor(ledgerName: string, tableName: string, checkForTable?: boolean, region: string = "ap-southeast-1") {
        ...
        try {
            ...
            this.qldbDriver = createQldbDriver(ledgerName, {region});
